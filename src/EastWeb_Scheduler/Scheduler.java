...
import EastWeb_Indices.IndicesWorker;
import EastWeb_Manager.IEASTWebManager;
import EastWeb_ProcessWorker.GenericProcess;
import EastWeb_ProcessWorker.ProcessWorker;
import EastWeb_ProcessWorker.ProcessWorkerReturn;
import EastWeb_Processor.ProcessorWorker;
import EastWeb_Scheduler.ProcessName;
import EastWeb_Summary.Summary;
...
import Utilies.ProgressUpdater;
...
public class Scheduler {
    ...
    private final IEASTWebManager manager;
     ...
     */
    public Scheduler(SchedulerData data, int myID, IEASTWebManager manager, Config configInstance)
    {
     ...
     * @param configInstance
     */
    public Scheduler(SchedulerData data, int myID, TaskState initState, IEASTWebManager manager, Config configInstance)
    {
     ...
     */
    public Scheduler(SchedulerData data, int myID, TaskState initState, IEASTWebManager manager, Config configInstance, ProgressUpdater progressUpdater)
    {
    ...
    protected Scheduler(ProjectInfoFile projectInfoFile, PluginMetaDataCollection pluginMetaDataCollection, boolean clearIntermediateFiles, int myID, Config configInstance,
            IEASTWebManager manager, SchedulerStatusContainer statusContainer)
    {
        data = new SchedulerData(projectInfoFile, pluginMetaDataCollection, clearIntermediateFiles);
        this.projectInfoFile = projectInfoFile;
        this.pluginMetaDataCollection = pluginMetaDataCollection;
