...
import Utilies.ReadShapefile;
import Utilies.ShapefileException;
...
public class AssociateSummaryPage {
    ...
    private void initialize() {
        ...
        browseButton.setIcon(new ImageIcon(this.getClass().getResource("/Images/folder-explore-icon.png")));
