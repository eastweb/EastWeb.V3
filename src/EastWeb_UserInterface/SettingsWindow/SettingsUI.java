package EastWeb_UserInterface.SettingsWindow;
...
public class SettingsUI {
    ...
    private void initialize() throws IOException {
        ...
        browseErrorLogDirButton.setIcon(new ImageIcon(this.getClass().getResource("/Images/folder-explore-icon.png")));
        ...
        browseDownloadDirButton.setIcon(new ImageIcon(this.getClass().getResource("/Images/folder-explore-icon.png")));
    ...
    private void advanceUI() throws IOException {
        ...
        refreshButton.setIcon(new ImageIcon(SettingsUI.class.getResource("/Images/Refresh.png")));
