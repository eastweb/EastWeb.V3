...
import EastWeb_UserInterface.PluginWindow.PluginExtension.Plugin;
...
public class AssociatePluginPage {
    ...
    private void pluginInformation(final JPanel pluginPanel) {
        ...
        btnAddIndices.setIcon(new ImageIcon(this.getClass().getResource("/Images/action_add_16xLG.png")));
        ...
        btnDeleteIndicies.setIcon(new ImageIcon(this.getClass().getResource("/Images/trashCan.png")));
    ...
    private void populatePluginInfo(final JPanel pluginPanel) {
        ...
        Class<?> pluginUI;
        try {
            pluginUI = Class.forName(String.format("EastWeb_UserInterface.PluginWindow.PluginExtension.%sPluginUI", plugin.Title));
