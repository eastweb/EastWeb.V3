...
public class NldasNOAHMeanDailySoilTemp0_10 extends IndicesFramework{

    private final static int INPUT = 0;

    public NldasNOAHMeanDailySoilTemp0_10(List<File> inputFiles, File outputFile, Integer noDataValue)
    {
