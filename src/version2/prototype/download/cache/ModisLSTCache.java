...
public class ModisLSTCache implements Cache {
    ...
    public ModisLSTCache(DataDate dataDate, DataDate startDate, List<DataDate> finished, List<ModisTile> tiles) {
    ...
    public boolean equals(ModisLSTCache o) {
