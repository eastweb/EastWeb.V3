...
public final class NldasForcingFactory extends DownloadFactory {
    ...
    public NldasForcingFactory(EASTWebI manager, Config configInstance, ProjectInfoFile projectInfoFile, ProjectInfoPlugin pluginInfo, PluginMetaData pluginMetaData, Scheduler scheduler,
