...
public class TRMM3B42RTFactory extends DownloadFactory {
    ...
    public TRMM3B42RTFactory(EASTWebI manager, Config configInstance, ProjectInfoFile projectInfoFile, ProjectInfoPlugin pluginInfo, PluginMetaData pluginMetaData, Scheduler scheduler,
