 ...
 */
public final class NldasNOAHDownloader extends DownloaderFramework {
    private final DataDate mDate;
    private final File mOutFile;

    private static DownloadMetaData metaData;

    public NldasNOAHDownloader(DataDate date, File outFile, DownloadMetaData data) {
        mDate=date;
        mOutFile=outFile;
        metaData = data;
    }

    public NldasNOAHDownloader() {
        mDate=null;
        mOutFile=null;
    }
    ...
    public static final List<DataDate> listDates(DataDate startDate)
        ...
        try {
            ...
            NldasNOAHDownloader nd=new NldasNOAHDownloader();
