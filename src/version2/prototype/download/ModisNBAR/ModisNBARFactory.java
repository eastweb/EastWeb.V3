...
public class ModisNBARFactory extends DownloadFactory {
    ...
    public ModisNBARFactory(EASTWebManagerI manager, Config configInstance, ProjectInfoFile projectInfoFile, ProjectInfoPlugin pluginInfo, PluginMetaData pluginMetaData, Scheduler scheduler,
    ...
    public ListDatesFiles CreateListDatesFiles() throws IOException {
        return new ModisNBARListDatesFiles(new DataDate(startDate), dData, projectInfoFile );
    }
