...
public class ModisNBARQCFactory extends DownloadFactory {
    ...
    public ModisNBARQCFactory(EASTWebManager manager, Config configInstance, ProjectInfoFile projectInfoFile, ProjectInfoPlugin pluginInfo, PluginMetaData pluginMetaData, Scheduler scheduler,
