...
public class ZonalSummaryCalculator {
     ...
     */
    public ZonalSummaryCalculator(String projectName, File inRasterFile, File inShapeFile, File outTableFile, String zoneField,
            SummariesCollection summariesCollection)
    {
