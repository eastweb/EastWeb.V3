...
public interface GUIUpdateHandler {
     ...
     *
     * @param statuses  - The current SchedulerStatuses of all the Schedulers. Some may not have seen any changes since previous invocations.
     */
    void run(ArrayList<SchedulerStatus> statuses);
}
