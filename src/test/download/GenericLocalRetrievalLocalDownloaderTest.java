...
public class GenericLocalRetrievalLocalDownloaderTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        indices.add("h01v01");
        pluginMetaData = PluginMetaDataCollection.CreatePluginMetaData(null, 1, null, null, extraDownloadFiles, null, null, null, null, null, null);
    ...
    private class MyScheduler extends Scheduler
    {
        public MyScheduler(int myID, Config configInstance) throws ParserConfigurationException, SAXException, IOException {
            super(null, null, false, myID, configInstance, null, new SchedulerStatusContainer(configInstance, 1, null, null, null, null, null, TaskState.STARTED, null, null, null, null, false, null));
        }
