...
public class TestProcessWorkerNldasNOAH {
    ...
    public final void testCall() throws Exception {
        ...
        ProjectInfoFile projectInfoFile = new ProjectInfoFile("C:\\Users\\veronica\\Documents\\32-bit\\workspace\\EastWeb.V2\\src\\version2\\prototype\\ProjectInfoMetaData\\Project_EA.xml");
        ProjectInfoPlugin pluginInfo = projectInfoFile.GetPlugins().get(0);
        PluginMetaData pluginMetaData = PluginMetaDataCollection.getInstance(new File("C:\\Users\\veronica\\Documents\\32-bit\\workspace\\EastWeb.V2\\src\\version2\\prototype\\PluginMetaData\\Plugin_NldasNOAH.xml")).pluginMetaDataMap.get(projectInfoFile.GetPlugins().get(0).GetName());
        ...
        File[] list = new File("C:\\project\\download\\NLDASNOAH\\2015\\155").listFiles();
